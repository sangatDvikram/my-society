...
/**
 * Single CSS entry-point for the super-admin app.
...
export const metadata: Metadata = {
  title: 'My Society — Super Admin Console',
  description:
    'Super admin console — platform-wide tenant management, billing, compliance & audit trail.',
  icons: {
    icon: [
