...
/**
 * DatabaseModule — Configures TypeORM with PostgreSQL for the super-admin-service.
 *
 ...
 *   DB_NAME     — Database name             (default: super_admin_service_db)
 *
...
@Module({
  imports: [
    TypeOrmModule.forRoot({
      ...
      database: process.env['DB_NAME']     ?? 'super_admin_service_db',
